...
ARG DATABRICKS_BUCKET
ARG ABNORMALITY_FEEDBACK_BUCKET
...
ENV PROTOCOL_FFT_ONLY = ${PROTOCOL_FFT_ONLY}

ENV DATABRICKS_BUCKET=${DATABRICKS_BUCKET}
ENV ABNORMALITY_FEEDBACK_BUCKET=${ABNORMALITY_FEEDBACK_BUCKET}
